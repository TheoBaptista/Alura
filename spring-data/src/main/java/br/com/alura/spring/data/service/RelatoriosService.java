...
public class RelatoriosService {
	...
	private void pesquisaFuncionarioSalario() {
		List<FuncionarioProjection> funcionarios = funcionarioRepository.findFuncionarioSalario();
		funcionarios.forEach(funcionario -> System.out.println("Nome :" + funcionario.getNome() +" |  Id: " + funcionario.getId() +" |  Salario: "+ funcionario.getSalario()));
	}
