...
public class LeiloesTest {
	...
	public void beforeEach() {
		LoginPage paginaDeLogin = new LoginPage(new ChromeDriver());
	...
	@Test
	public void deveriaExecutarValidacoesAoCadastrarLeilaoComDadosInvalidos() {
		...
		Assert.assertTrue(paginaDeCadastroDeLeilao.isMensagemDeValidacaoVisiveis());
	}
